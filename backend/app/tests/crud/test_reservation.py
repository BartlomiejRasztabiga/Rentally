...
def test_create_reservation_same_car_same_dates_will_throw(db: Session) -> None:
    ...
    reservation_create_dto = get_test_reservation_create_dto(car, customer, start_date1, end_date1)
    crud.reservation.create(db=db, obj_in=reservation_create_dto)
...
def test_create_reservation_same_car_one_day_intersection_will_throw(db: Session) -> None:
    car = create_random_car(db)
    customer = create_random_customer(db)
...
def test_create_reservation_same_car_one_day_intersection_will_throw2(db: Session) -> None:
    car = create_random_car(db)
    customer = create_random_customer(db)
