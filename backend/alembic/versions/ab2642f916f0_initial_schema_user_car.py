...
Revision ID: ab2642f916f0
Revises: 
Create Date: 2020-12-08 00:43:51.990006
...
def upgrade():
    ...
    sa.Column('fuel_type', sa.Enum('PETROL', 'DIESEL', 'HYBRID', 'EV', name='fueltype'), nullable=False),
